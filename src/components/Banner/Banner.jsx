        ...
        <div className='bg-[#f5f5f5] pt-[40px] lg:pt-[80px] px-10 lg:px-20'>
            <div className='flex flex-col items-center justify-center text-center'>
                ...
                <div className='btn_box flex-wrap justify-center flex gap-4 my-9 lg:my-14'>
                    <Link to="https://play.google.com/store/games?hl=en" className='flex flex-wrap items-center gap-2 rounded-[4px] border border-[#D2D2D2] px-6 py-3 text-[18px] lg:text-[20px] text-[#001931] font-semibold hover:shadow-[0_1px_5px_2px_rgba(0,0,0,0.1)] transition duration-300'> <img src={googAppBtn}/> Google Play</Link>
                    <Link to="https://www.apple.com/app-store/" className='flex flex-wrap items-center gap-2 rounded-[4px] border border-[#D2D2D2] px-6 py-3 text-[18px] lg:text-[20px] text-[#001931] font-semibold hover:shadow-[0_1px_5px_2px_rgba(0,0,0,0.1)] transition duration-300'>  <img src={appStoreBtn}/> App Store</Link>
                </div>
